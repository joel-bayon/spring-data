...
@NamedQuery(name = "Adherent.findByPrenom",
			query = "select a from Adherent a where a.prenom = :prenom")
@NamedQueries({
	@NamedQuery(name = "Adherent.getByEmail",
				query = "select a from Adherent a where a.email = ?1"),
	@NamedQuery(name = "Adherent.getByLivre",
